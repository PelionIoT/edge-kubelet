...
func NewForConfig(c *rest.Config) (*ArgusAppsV1Client, error) {
	...
	return &ArgusAppsV1Client{client}, nil
}

// NewForConfigOrDie creates a new ArgusAppsV1Client for the given config and
...
func New(c rest.Interface) *ArgusAppsV1Client {
	return &ArgusAppsV1Client{c}
}
