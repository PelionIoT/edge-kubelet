...
type NetworkPoliciesGetter interface {
	NetworkPolicies(aid, namespace string) NetworkPolicyInterface
}
...
func newNetworkPolicies(c *ArgusNetworkingV1Client, accountid, namespace string) *networkPolicies {
